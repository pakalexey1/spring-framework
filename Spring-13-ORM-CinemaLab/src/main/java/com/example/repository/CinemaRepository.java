...
public interface CinemaRepository extends JpaRepository<Cinema, Long> {
    ...
    List<Cinema> retrieveAllByLocationCountry(String country);
    ...
    List<Cinema> listAllCinemasByNameOrSponsoredName(String name);
    ...
    List<String> listDistinctCinemasBySponsoredName();
